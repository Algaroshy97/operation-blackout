...
function vmMat(params) {
  ...
  if (SKY_ENV) { m.envMap = SKY_ENV; if (params.envMapIntensity === undefined) m.envMapIntensity = 0.7; }
  return m;
}
const VMAT = {
...
const gunKey = new THREE.DirectionalLight(0xffc49a, 1.5 * LIGHT_COMPAT);
